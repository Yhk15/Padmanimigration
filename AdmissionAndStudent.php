  ...
  <div class="container">
    ...
    <form id="visaForm" action="Submit.php" method="POST" class="bg-white p-4 rounded shadow">
        ...
        <select class="form-select" id="visaType" name="visaType" onchange="handleVisaRedirect(this)" required>
          ...
          <option value="Admission And Student" selected>Admission And Student</option>
...
<!-- Bootstrap Bundle JS (includes Popper.js for modal functionality) -->
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>

<script>
document.addEventListener('DOMContentLoaded', function () {
  // ======= Visa Type Redirect ========
  window.handleVisaRedirect = function (selectElement) {
    ...
    if (visaRedirectMap[selectedValue]) {
